export type TermsMerchantsContent = {
  title: string;
  sections: Array<{
    id: string;
    title: string;
...
export const termsMerchantsContent = {
  en: {
    ...
    sections: [
      ...
      {
        id: 'compliance',
        title: '5. Compliance and Regulations',
        content:
  ...
  'pt-BR': {
    ...
    sections: [
      ...
      {
        id: 'merchant-obligations',
        title: '2. Obrigações do Merchant',
        content:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.',
      },
      {
      ...
      {
        id: 'fees-charges',
        title: '4. Taxas e Encargos',
        content:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.',
      },
      {
        id: 'compliance',
        title: '5. Conformidade e Regulamentações',
        content:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.',
      },
      {
  ...
  'es': {
    ...
    sections: [
      ...
      {
        id: 'merchant-obligations',
        title: '2. Obligaciones del Comerciante',
        content:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.',
      },
      {
      ...
      {
        id: 'compliance',
        title: '5. Cumplimiento y Regulaciones',
        content:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.',
      },
      {
