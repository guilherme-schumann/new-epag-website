  ...
  return (
    <section className="bg-background">
      <div className="page-section page-container">
        <div className="rounded-hero bg-secondary-900 px-8 py-16 text-center xl:px-16">
          ...
          <motion.h2
            className="mx-auto max-w-3xl text-3xl font-extrabold leading-tight tracking-tight text-secondary-100 md:text-4xl xl:text-[2.75rem]"
