  ...
  return (
    <aside className="flex w-52 flex-col bg-secondary-900 min-h-screen">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-colors ${
                active ? 'bg-primary-500/20 text-primary-500' : 'text-light/60 hover:bg-light/5 hover:text-light'
              }`}
            >
      ...
      <div className="px-4 py-4 border-t border-light/10">
        ...
        <button onClick={handleLogout} className="text-xs text-light/40 hover:text-light/70 transition-colors">
          {a.signOut}
        </button>
      </div>
    </aside>
